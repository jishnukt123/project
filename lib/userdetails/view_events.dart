...
class view_events extends StatefulWidget {
  ...
  @override
  State<view_events> createState() => _view_eventsState();
}
                    ...
                    children: [
                      Padding(
                        ...
                        child: ListTile(
                          ...
                          trailing: GestureDetector(child: Icon(Icons.navigate_next_sharp,size: 40,color: Colors.white,),
                            onTap: (){
                              Navigator.push(context, MaterialPageRoute(builder: (context)=>eventdetailsusr(data:snapshot.data[index])));
                            },),
                        ),
                      )
                    ],
