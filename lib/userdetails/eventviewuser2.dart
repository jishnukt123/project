...
import 'package:hope/userdetails/usereventedit.dart';
...
class eventviewuser2 extends StatefulWidget {

  const eventviewuser2({Key? key}) : super(key: key);

  @override
  State<eventviewuser2> createState() => _eventviewuser2State();
}

class _eventviewuser2State extends State<eventviewuser2> {
                    ...
                    children: [
                      Padding(
                        ...
                        child: ListTile(
                          ...
                          trailing: GestureDetector(child: Icon(Icons.edit,color: Colors.white,),
                            onTap: (){
                              Navigator.push(context, MaterialPageRoute(builder: (context)=>usereventedit(data:snapshot.data[index])));
                            },),
                        ),
                      )
                    ],
